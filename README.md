...
```bash
nix run github:bertie-mc/bertie-ci/v3.3.2#bertie-ci -- \
  build --project . --output-dir .bertie-ci/artifact
nix run github:bertie-mc/bertie-ci/v3.3.2#bertie-ci -- unit-test --project .
nix run github:bertie-mc/bertie-ci/v3.3.2#bertie-ci -- gametest --project .
nix run github:bertie-mc/bertie-ci/v3.3.2#bertie-ci -- \
...
```bash
nix run github:bertie-mc/bertie-ci/v3.3.2#bertie-ci -- pack-validate --project .
nix run github:bertie-mc/bertie-ci/v3.3.2#bertie-ci -- \
...
- `bertie-mc/bertie-ci/actions/setup-nix@v3.3.2`
- `bertie-mc/bertie-ci/actions/build@v3.3.2`
- `bertie-mc/bertie-ci/actions/unit-test@v3.3.2`
- `bertie-mc/bertie-ci/actions/gametest@v3.3.2`
- `bertie-mc/bertie-ci/actions/prepare-mod-instance@v3.3.2`
- `bertie-mc/bertie-ci/actions/prepare-pack-instance@v3.3.2`
- `bertie-mc/bertie-ci/actions/client-probe@v3.3.2`
- `bertie-mc/bertie-ci/actions/server-probe@v3.3.2`
- `bertie-mc/bertie-ci/actions/pack-validate@v3.3.2`
- `bertie-mc/bertie-ci/actions/pack-resolve@v3.3.2`
- `bertie-mc/bertie-ci/actions/pack-export-client@v3.3.2`
- `bertie-mc/bertie-ci/actions/pack-export-server@v3.3.2`
- `bertie-mc/bertie-ci/actions/github-release@v3.3.2`
...
jobs:
  build:
    uses: bertie-mc/bertie-ci/.github/workflows/build-mod.yml@v3.3.2

  unit-test:
    uses: bertie-mc/bertie-ci/.github/workflows/unit-test.yml@v3.3.2

  gametest:
    uses: bertie-mc/bertie-ci/.github/workflows/gametest.yml@v3.3.2

  client:
    needs: build
    uses: bertie-mc/bertie-ci/.github/workflows/client.yml@v3.3.2
    with:
  ...
  server:
    needs: build
    uses: bertie-mc/bertie-ci/.github/workflows/server.yml@v3.3.2
    with:
      artifact-name: ${{ needs.build.outputs.artifact-name }}
      fixture: forbidden-arcanus,irons-spells
```
...
jobs:
  ...
  publish:
    ...
    permissions:
      contents: write
    uses: bertie-mc/bertie-ci/.github/workflows/github-release.yml@v3.3.2
    with:
      artifact-name: ${{ needs.build.outputs.artifact-name }}
```
